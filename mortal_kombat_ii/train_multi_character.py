#!/usr/bin/env python3
"""
Train a generic fighter using all 12 playable MK2 characters.
...
# All 12 playable MK2 character starting states
CHARACTER_STATES = [
    "Fight_LiuKang",
    "Fight_KungLao",
    "Fight_JohnnyCage",
...
print("="*60)
print("MK2 MULTI-CHARACTER TRAINING - PHASE 1")
print("="*60)
...
if __name__ == '__main__':
    ...
    print("Model will be saved to: models/mk2_multichar_ppo_*.zip\n")
