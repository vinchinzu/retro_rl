...
- Historical plans and one-off experiments belong in `docs/archive/` or
  `scripts/archive/`.
...
- `python -m SMW`: local CLI entrypoint, delegating platformer commands to
  `platformer_common.runner`.
- `platformer_common/levels/super_mario_world.py`: published SMW RAM/action
