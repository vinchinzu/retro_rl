...
- `platformer_common/levels/super_mario_world.py`
- `recordings/`
- `optimizer/`
...
- Use the shared `platformer_common` commands for play, verify, hillclimb,
...
SMW/
  ...
  docs/archive/         stale plans and old investigations
...
Use `platformer_common` when behavior is useful to other platformers:
