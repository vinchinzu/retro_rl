"""Donkey Kong Country level configurations.

All DKC levels share the same RAM layout (DKC_RAM). Adding a new level
is just a register_level() call with a different start_state and target_level_id.
"""

from platformer_common.level_config import PlatformerRAM, LevelConfig, register_level
from platformer_common.actions import _make, SNES_RIGHT, SNES_LEFT, SNES_UP, SNES_DOWN, SNES_B, SNES_Y
