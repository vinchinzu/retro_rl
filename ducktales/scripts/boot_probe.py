"""Boot DuckTales (NES) from reset and save a controllable Level1 state."""
...
from ducktales.menus import boot_to_level1_script
from ducktales.paths import GAME, GAME_DIR, RECORDINGS_DIR
from ducktales.ram import is_level1_ready, parse_game_state
