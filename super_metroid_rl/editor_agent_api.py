...
class EditorAgentApi:
    ...
    def __init__(
        ...
        *,
        ...
        self.process = subprocess.Popen(
            [self.python_executable, str(self.project_dir / "editor_bridge.py"), "--stdio"],
    ...
    def watch_snapshot(self, *, include_frame: bool = False) -> dict[str, Any]:
        return self.request("snapshot", include_frame=include_frame)
    ...
    def step(
        ...
        *,
        ...
        return self.request("step", action=action, repeat=repeat, include_frame=include_frame)
