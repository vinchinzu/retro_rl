...
Usage::
    ...
    uv run python -m retro_harness.platformer.state_creator \\
...
def main():
    ...
    parser.add_argument("--game-dir", required=True, help="Game directory slug (under snes/ or nes/)")
    ...
    try:
        ...
        game_dir = monorepo_root() / args.game_dir
