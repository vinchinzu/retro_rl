...
def get_smb_bottleneck_windows() -> tuple[RleWindow, ...]:
    """Lazy load SMB polish windows from the game package (no RAM/seed constants here)."""
    from smb.rle_windows import SMB_BOTTLENECK_WINDOWS

    return SMB_BOTTLENECK_WINDOWS


def __getattr__(name: str):
    # Back-compat: ``from rle_optimize import SMB_BOTTLENECK_WINDOWS``
