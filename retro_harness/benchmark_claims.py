...
Benchmark execution and report serialization live in
:mod:`retro_harness.benchmark_runner`. The legacy
:mod:`retro_harness.benchmark` module re-exports this public surface.
