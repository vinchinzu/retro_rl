...
class TestWinConditionInSource(unittest.TestCase):
    ...
    def _find_python_files(self):
        ...
        files = []
        roots = [
            resolve_game_dir("mortal_kombat"),
            resolve_game_dir("mortal_kombat_ii"),
            resolve_game_dir("street_fighter_ii"),
            resolve_game_dir("super_street_fighter_ii"),
            ROOT_DIR / "retro_harness" / "fighters",
        ]
        for d in roots:
            if not d.exists():
                continue
    ...
    def test_benchmark_scripts_have_full_condition(self):
        ...
        critical_scripts = [
            ROOT_DIR / "snes" / "mortal_kombat" / "benchmark_characters.py",
            ROOT_DIR / "snes" / "mortal_kombat" / "match_manager.py",
            ROOT_DIR / "snes" / "mortal_kombat" / "model_registry.py",
        ]
...
class TestFightingEnvTermination(unittest.TestCase):
    ...
    def test_terminates_on_two_wins(self):
        ...
        from retro_harness.fighters.fighting_env import FightingEnv
