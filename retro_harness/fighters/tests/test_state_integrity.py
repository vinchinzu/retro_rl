...
def _get_state_dir(game_alias):
    ...
    return resolve_game_dir(config.game_dir_name) / "custom_integrations" / config.game_id
...
class TestStateConsistency(unittest.TestCase):
    ...
    def test_data_json_has_required_keys(self):
        ...
        for alias in ["mk1", "mk2", "sf2", "ssf2"]:
            ...
            data_json = resolve_game_dir(config.game_dir_name) / "custom_integrations" / config.game_id / "data.json"
