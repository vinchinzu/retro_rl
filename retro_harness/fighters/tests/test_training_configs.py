...
- Training scripts not matching AGENTS.md / local guide documentation
...
from retro_harness.fighters.game_configs import get_game_config, GAME_REGISTRY
...
class TestTrainingScriptLineage(unittest.TestCase):
    ...
    def test_mk1_train_match2_base(self):
        script = ROOT_DIR / "snes" / "mortal_kombat" / "train_match2.py"
    ...
    def test_mk1_no_script_uses_forbidden_base(self):
        ...
        mk_dir = ROOT_DIR / "snes" / "mortal_kombat"
...
class TestLROverride(unittest.TestCase):
    ...
    def test_train_ppo_uses_custom_objects_for_lr(self):
        ...
        script = ROOT_DIR / "retro_harness" / "fighters" / "train_ppo.py"
...
class TestTrainingStateReferences(unittest.TestCase):
    ...
    def test_mk1_train_match2_states_exist(self):
        ...
        content = script.read_text()
        state_dir = ROOT_DIR / "snes" / "mortal_kombat" / "custom_integrations" / "MortalKombat-Snes"
    ...
    def test_mk1_train_multi_character_states_exist(self):
        script = ROOT_DIR / "snes" / "mortal_kombat" / "train_multi_character.py"
        if not script.exists():
