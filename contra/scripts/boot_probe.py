"""Boot Contra (NES) from reset and save a controllable Level1 state."""
...
from contra.menus import boot_to_level1_script
from contra.paths import GAME, GAME_DIR, RECORDINGS_DIR
from contra.ram import is_level1_ready, parse_game_state
