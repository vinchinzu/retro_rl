...
|-------|-------|
| Current maturity | M1 |
| Best verified result | Controllable first playable frame (title/file → North Palace) |
...
| ROM zip | `roms/Nintendo/NES/Zelda II - The Adventure of Link.zip` |
| Ready frame (probe) | ~1086 |
