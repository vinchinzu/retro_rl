"""Boot Zelda II (NES) from reset and save a controllable Level1 state."""

from __future__ import annotations

from retro_harness.boot_probe import BootProbeConfig, main_boot_probe, run_boot_probe
from zelda_ii.menus import boot_to_level1_script
from zelda_ii.paths import GAME, GAME_DIR, RECORDINGS_DIR
from zelda_ii.ram import is_level1_ready, parse_game_state
