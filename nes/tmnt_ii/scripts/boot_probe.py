...
from tmnt_ii.menus import BOOT_LEFTOVER_WALK_FRAMES, boot_to_level1_script
...
CFG = BootProbeConfig(
    ...
    walk_frames=BOOT_LEFTOVER_WALK_FRAMES,
)


def run_probe(
    *, save_level1: bool = True, walk_frames: int = BOOT_LEFTOVER_WALK_FRAMES
) -> int:
...
def main() -> None:
    """CLI entry point."""
    raise SystemExit(main_boot_probe(CFG, walk_default=BOOT_LEFTOVER_WALK_FRAMES))
