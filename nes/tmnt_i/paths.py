"""Filesystem and integration constants for Teenage Mutant Ninja Turtles."""

from __future__ import annotations

from retro_harness.game_layout import game_paths

_paths = game_paths(__file__, "TeenageMutantNinjaTurtles-Nes")
...
SHARED_ROM_ZIP = REPO_ROOT / "roms" / "Nintendo" / "NES" / "Teenage Mutant Ninja Turtles.zip"
LEVEL1_STATE = "Level1"
