...
|-------|-------|
| Current maturity | M1 |
| Best verified result | Controllable first playable frame (title/character → Area 1 outdoor map) |
...
| ROM zip | `roms/Nintendo/NES/Teenage Mutant Ninja Turtles.zip` |
| Ready frame (probe) | ~419 |
