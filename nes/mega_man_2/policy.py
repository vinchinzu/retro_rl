...
@dataclass
class AirManPolicy:
    """Multi-phase Air Man route: Level1 → camera screen ≥ 2."""
    ...
    # "level1" uses full recipe; "landed" uses post-land phase only
    start: str = "level1"
