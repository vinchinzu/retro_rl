"""Boot Mike Tyson's Punch-Out!! (NES) from reset and save a controllable Level1 state."""
...
from punch_out.menus import boot_to_level1_script
from punch_out.paths import GAME, GAME_DIR, RECORDINGS_DIR
from punch_out.ram import is_level1_ready, parse_game_state
