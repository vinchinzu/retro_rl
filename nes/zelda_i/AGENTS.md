...
| `level*_path.py`, `level*_boss_*` | Path controllers + timing knobs |
...
Tip + parked work live in `docs/plan.md` (Survival spine `rr-4d53`; L5/L9
recon parked). Do not start a new room or route leaf unless that is the
claimed bead.
