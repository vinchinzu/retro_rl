...
Gleeok fight, Rod, and cellar return are on the tape
(`l6_exit75_continuous_v3` 1/1, leftover play `0x09` `(192,141)` rod=1
bow=0 arrows=0). Gohma / TF `0x20` residual — Gohma needs an arrow.
