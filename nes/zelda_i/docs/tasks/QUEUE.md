...
| Tip leaf | **L3 Manhandla residual** | Raft runner **2/2 assisted** (`Level3Raft`); Manhandla → TF `0x04` (`rr-vpl`) |
...
| **rr-vpl** tip | Raft **2/2 assisted** (`run_level3_raft.py` / `Level3Raft`); Manhandla → TF residual |
