...
_LAZY_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "walk_west_from_27": ("zelda_i.level5_west_path", "walk_west_from_27"),
    "walk_west_from_26": ("zelda_i.level5_west_path", "walk_west_from_26"),
    "walk_west_from_25": ("zelda_i.level5_west_path", "walk_west_from_25"),
    "WEST26_TO_25_PATHS": ("zelda_i.level5_west_path", "WEST26_TO_25_PATHS"),
    "WEST25_TO_24_PATHS": ("zelda_i.level5_west_path", "WEST25_TO_24_PATHS"),
    # whistle inbound
    "ROOM_L5_BLUE_64": ("zelda_i.level5_whistle_path", "ROOM_L5_BLUE_64"),
    "ROOM_L5_CELLAR_07": ("zelda_i.level5_whistle_path", "ROOM_L5_CELLAR_07"),
    "ROOM_L5_PASSAGE_06": ("zelda_i.level5_whistle_path", "ROOM_L5_PASSAGE_06"),
    "ROOM_L5_WHISTLE_05": ("zelda_i.level5_whistle_path", "ROOM_L5_WHISTLE_05"),
    ...
    "L5_CELLAR_LEFT_X": ("zelda_i.level5_whistle_path", "L5_CELLAR_LEFT_X"),
    "L5_CELLAR_RIGHT_X": ("zelda_i.level5_whistle_path", "L5_CELLAR_RIGHT_X"),
    "ROOM_06_BLOCK_X": ("zelda_i.level5_whistle_path", "ROOM_06_BLOCK_X"),
    "ROOM_06_BLOCK_REST_Y": ("zelda_i.level5_whistle_path", "ROOM_06_BLOCK_REST_Y"),
    "ROOM_06_BLOCK_PUSHED_Y": ("zelda_i.level5_whistle_path", "ROOM_06_BLOCK_PUSHED_Y"),
    "ROOM_06_STAIRS_X": ("zelda_i.level5_whistle_path", "ROOM_06_STAIRS_X"),
    "ROOM_06_STAIRS_Y": ("zelda_i.level5_whistle_path", "ROOM_06_STAIRS_Y"),
    "WHISTLE_04_LADDER_X": ("zelda_i.level5_whistle_path", "WHISTLE_04_LADDER_X"),
    "WHISTLE_04_PIT_Y": ("zelda_i.level5_whistle_path", "WHISTLE_04_PIT_Y"),
    "WHISTLE_04_MOUTH_X": ("zelda_i.level5_whistle_path", "WHISTLE_04_MOUTH_X"),
    "WHISTLE_04_MOUTH_Y": ("zelda_i.level5_whistle_path", "WHISTLE_04_MOUTH_Y"),
    "select_b_item_menu": ("zelda_i.level5_whistle_path", "select_b_item_menu"),
    "bomb_west_from_65": ("zelda_i.level5_whistle_path", "bomb_west_from_65"),
    "bomb_east_from_65": ("zelda_i.level5_whistle_path", "bomb_east_from_65"),
    "take_center_stairs_64": ("zelda_i.level5_whistle_path", "take_center_stairs_64"),
    "cellar_other_mouth": ("zelda_i.level5_whistle_path", "cellar_other_mouth"),
    "key_west_to": ("zelda_i.level5_whistle_path", "key_west_to"),
    "fight_blue_darknuts": ("zelda_i.level5_whistle_path", "fight_blue_darknuts"),
    "push_block_stairs": ("zelda_i.level5_whistle_path", "push_block_stairs"),
    "hunt_whistle": ("zelda_i.level5_whistle_path", "hunt_whistle"),
    "take_whistle_04": ("zelda_i.level5_whistle_path", "take_whistle_04"),
    "exit_whistle_04": ("zelda_i.level5_whistle_path", "exit_whistle_04"),
    "leave_whistle_cellar": ("zelda_i.level5_whistle_path", "leave_whistle_cellar"),
    "walk_out_of_04": ("zelda_i.level5_whistle_path", "walk_out_of_04"),
    # cellar / east return
    "_raw_axis": ("zelda_i.level5_cellar_path", "_raw_axis"),
    "take_center_stairs_06": ("zelda_i.level5_cellar_path", "take_center_stairs_06"),
    "cellar_to_64": ("zelda_i.level5_cellar_path", "cellar_to_64"),
    "walk_east_from_05": ("zelda_i.level5_cellar_path", "walk_east_from_05"),
    "take_block_stairs_06": ("zelda_i.level5_cellar_path", "take_block_stairs_06"),
    "cellar_07_to_64": ("zelda_i.level5_cellar_path", "cellar_07_to_64"),
    "walk_east_from_64": ("zelda_i.level5_cellar_path", "walk_east_from_64"),
    "EAST65_TO_66_PATHS": ("zelda_i.level5_cellar_path", "EAST65_TO_66_PATHS"),
    "walk_east_from_65": ("zelda_i.level5_cellar_path", "walk_east_from_65"),
    # TF / Digdogger north
    "ROOM_L5_EAST_ZOLS": ("zelda_i.level5_tf_path", "ROOM_L5_EAST_ZOLS"),
    "ROOM_L5_NORTH_GIBDOS": ("zelda_i.level5_tf_path", "ROOM_L5_NORTH_GIBDOS"),
    "STATUE_5F_TYPE": ("zelda_i.level5_tf_path", "STATUE_5F_TYPE"),
    "STATUE_5F_X": ("zelda_i.level5_tf_path", "STATUE_5F_X"),
    "STATUE_5F_Y": ("zelda_i.level5_tf_path", "STATUE_5F_Y"),
    "DIAMOND_NORTH_Y": ("zelda_i.level5_tf_path", "DIAMOND_NORTH_Y"),
    "NORTH_DOOR_Y": ("zelda_i.level5_tf_path", "NORTH_DOOR_Y"),
    "walk_north_from_57": ("zelda_i.level5_tf_path", "walk_north_from_57"),
}
