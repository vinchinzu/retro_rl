"""Level 4 live maze/BFS nav used by run_level4_rooms.

Env-step path helpers only. Room specs stay in level4_dungeon; controllers
stay in level4_path / level4_maze_path / level4_stepladder.
"""
