...
def live_killables(snap: ZeldaSnapshot, types: Sequence[int]) -> list:
    """Room-clear liveness on slots 1–12 (Keese/Gel = type; others HP>0)."""
    type_set = set(types)
    out = []
    for o in snap.objects:
...
__all__ = [
    "ADDR_SELECTED_ITEM", "B_ITEM_ARROWS", "B_ITEM_BOMB", "B_ITEM_BOMBS",
    "B_ITEM_CANDLE", "DARKNUT_OBJECT_TYPE", "DOOR_TARGETS",
    "GEL_ALT_OBJECT_TYPE", "GEL_SPLIT_OBJECT_TYPE", "INVULN_MOVER_0X2B",
    "KEESE_OBJECT_TYPE", "MANHANDLA_PROJECTILE_TYPE", "NON_COMBAT_TYPES",
    ...
    "poke_bombs", "poke_keys", "poke_link_position", "poke_wooden_arrows",
