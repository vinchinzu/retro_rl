...
# ends y=191). East gold x>=208 (right spine x=192–207). Isolated BFS no.
...
ROOM_20_NORTH_EAST_XY = (ROOM_20_EAST_XY[0], ROOM_20_NORTH_XY[1])
ROOM_20_CLIP_BUDGET = 96
# v13 north-around hit the east wall at (200,96); door is y=141. South
# gold y>=192 + door-column clip (v4 reached x=200 with Vire knockback).
