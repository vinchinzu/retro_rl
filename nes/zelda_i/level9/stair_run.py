...
from zelda_i.level9.ganon import ADDR_SELECTED_ITEM, B_ITEM_ARROWS, B_ITEM_BOMBS
...
from zelda_i.level9.stair_session import (  # noqa: E402
    ADDR_SUBMODE,
    ADDR_UPDATING,
    ADDR_UW_EXIT_TYPE,
    BEAD,
...
def run_to_credits(
    ...
    from zelda_i.level9.stair_suffix import run_suffix_from_live_env
