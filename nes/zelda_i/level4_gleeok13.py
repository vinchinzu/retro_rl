...
from zelda_i.level4_maze_path import PATH_12_TO_GLEEOK, PUSH_12_HOLD, RIGHT_12_HOLD
...
def run_level4_tf_suffix(env, *, assist, frame_base: int):
    ...
    from zelda_i.level4_boss_combat import make_gleeok_fight_controller
...
def attach_level4_tf_suffix(env, run, *, assist) -> bool:
    ...
    from zelda_i.level4_dungeon import LEVEL4_TRIFORCE_BIT
