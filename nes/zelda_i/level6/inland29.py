...
from zelda_i.level6.overworld import LEVEL6, LEVEL6_DARK_29_ROOM, LEVEL6_DARK_39_ROOM
from zelda_i.level6.path import NORTH_BAND_Y, NORTH_DOOR_X, NORTH_DOOR_Y
