...
from zelda_i.overworld import LEVEL1_PATH_SCREENS
...
_SWORD = "zelda_i.sword_cave.SwordCaveController"
_L1_OW = "zelda_i.overworld_nav.OverworldToLevel1Controller"
_L1_KEY = "zelda_i.level1.Level1FirstKeyController"
_L1_NORTH = "zelda_i.level1.Level1UnlockNorthController"
_L1_C63 = "zelda_i.level1.Level1Clear63Controller"
_L1_C53 = "zelda_i.level1.Level1Clear53Controller"
_L1_C54 = "zelda_i.dungeon.GenericDungeonRoomController"
_L1_DONE = "level1_complete_chain"
_L2_SETTLE = "zelda_i.level2_overworld.PostTriforceSettleController"
_L2_PREFIX = "zelda_i.level2_overworld.OverworldToLevel2Controller"
_L2_DOOR = "zelda_i.level2_overworld.OverworldToLevel2Controller"
_L2_ENTER = "zelda_i.level2_overworld.OverworldToLevel2Controller"
...
_L3_OW = "zelda_i.level3_overworld.OverworldPostL2ToLevel3Controller"
_L3_KEY = "zelda_i.level3_path.Level3WestKeyController"
_L3_RAFT = "zelda_i.level3_raft_path.Level3RaftPathController"
_L3_BOSS = "zelda_i.level3_boss_path.Level3BossPathController"
_L4_OW = "zelda_i.level4_overworld.OverworldToLevel4Controller"
_L4_LADDER = "zelda_i.level4_stepladder.Level4StepladderController"
_L4_BOSS = "zelda_i.level4_boss_combat.Level4GleeokFightController"
_L5_OW = "zelda_i.level5_overworld.OverworldToLevel5Controller"
_L5_RETURN = "zelda_i.level5_path.Level5Return66Controller"
_L5_POLS = "zelda_i.level5_dungeon.Level5PolsVoiceController"
_L9_PATRA = "zelda_i.level9_patra.FinalPatraFightController"
_L9_GANON = "zelda_i.level9_ganon.GanonFightController"
...
_LATER_ROWS: tuple[tuple[str, str, str, bool], ...] = (
    ...
    ("level5_whistle", "zelda_i.scripts.run_level5_east_to_whistle", "level5_whistle_collected", True),
    ("level5_digdogger", "zelda_i.level5_tf_path", "level5_digdogger_room", True),
    ("level5_triforce", "zelda_i.level5_tf_path", "triforce & 0x10", True),
    ("level9_41_to_31", "zelda_i.level9_path", "level9_in_room_31", True),
    ("level9_31_to_30", "zelda_i.level9_path", "level9_in_room_30", True),
    ("level9_30_to_67", "zelda_i.level9_path", "level9_in_cellar_67", True),
    ("level9_67_to_04", "zelda_i.level9_path", "level9_in_room_04", True),
    ("level9_04_to_03", "zelda_i.level9_path", "level9_in_room_03", True),
    ("level9_03_to_patra", "zelda_i.level9_path", "level9_patra_room", True),
...
def _resolve_named_route(route_id: str) -> Any:
    from zelda_i.routes import get_route
    from zelda_i.routes_later import get_later_route
...
def legs_for_named_route(route_id: str) -> tuple[Any, ...]:
    ...
    from zelda_i.route_legs_later import (
