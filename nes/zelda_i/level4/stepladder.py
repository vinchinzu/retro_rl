...
# mode-9 0x60 exit: clear 4x Keese then hold4 multi-grid BFS -> 0x32 play.
EXIT_60_HOLD = 4
...
# Post-ladder 0x32 -> free LEFT to 0x31 (BFS around pushed 0x68 block).
WEST_31_HOLD = 4
WEST_31_SAMPLE_PATH: tuple[str, ...] = (
    ("LEFT",) * 2 + ("DOWN",) * 2 + ("LEFT",) + ("DOWN",) * 6 + ("LEFT",) * 6
)
