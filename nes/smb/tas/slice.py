...
# Pure continuous FM2 8-3 still phase-blocked; **stitchless leave** via
# skill-resume (progress prefix + pure hop/flagpole macro) verified 2026-08-07:
# leave **2374f** 2/2 → 8-4 control (models/smb_8_3_stitchless_skills_leave.json).
# FM2 start index remains a search hint only — re-gate from is_8_3_control.
HL_8_3_FM2_START: int | None = None
HL_8_3_LEAVE_FRAMES: int | None = 2374  # skills leave (not pure FM2 body)
HL_8_3_SKILLS_LEAVE = MODELS_DIR / "smb_8_3_stitchless_skills_leave.json"
# Bridge: natural_82@15933 → 8-4 control (2227f). Showcase/hybrid only.
