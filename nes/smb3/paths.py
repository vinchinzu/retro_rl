"""Filesystem and integration constants for Super Mario Bros. 3."""

from __future__ import annotations

from retro_harness.game_layout import game_paths

_paths = game_paths(__file__, "SuperMarioBros3-Nes")
...
SHARED_ROM_ZIP = REPO_ROOT / "roms" / "Nintendo" / "NES" / "Super Mario Bros. 3.zip"
LEVEL1_STATE = "Level1"
