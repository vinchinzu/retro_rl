...
uv run python super_metroid/scripts/probe_route.py full --stop-after morph_ball
uv run python super_metroid/scripts/probe_route.py full-hybrid
uv run python super_metroid/scripts/probe_route.py leg landing_site morph_ball
```
"""
...
from super_metroid.dev_common import boot_from_state, make_dev_env  # noqa: E402
from super_metroid.phantoon_dev import (  # noqa: E402
    PHANTOON_ENTRY_STATE,
    capture_phantoon_entry,
)
from super_metroid.route_dev import (  # noqa: E402
...
def main() -> None:
    ...
    full_hybrid = sub.add_parser(
        "full-hybrid",
        help=(
            "Hybrid full-route video: continuous start_to_supers prefix + "
