...
uv run python super_metroid/scripts/export/kpdr_tracker.py --csv path --json out.json
```
"""
...
DEFAULT_CSV = ROOT / "super_metroid" / "docs" / "routes" / "KPDR_TRACKER.csv"
DEFAULT_JSON = ROOT / "super_metroid" / "maps" / "kpdr_tracker.json"
DEFAULT_MD = ROOT / "super_metroid" / "docs" / "routes" / "KPDR_TRACKER.md"
