...
uv run python super_metroid/scripts/export/room_work_queue.py --json PATH --csv PATH
```
"""
...
def main() -> None:
    ...
    if not args.catalog.is_file():
        raise SystemExit(
            ...
            "Regenerate with: uv run python super_metroid/scripts/export/room_problems.py"
        )
