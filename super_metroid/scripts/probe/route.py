...
uv run python super_metroid/scripts/probe/route.py full --stop-after morph_ball
uv run python super_metroid/scripts/probe/route.py full-hybrid
uv run python super_metroid/scripts/probe/route.py leg landing_site morph_ball
```
"""
