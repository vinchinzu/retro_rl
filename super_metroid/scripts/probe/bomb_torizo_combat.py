...
uv run python super_metroid/scripts/probe/bomb_torizo_combat.py strategy
...
uv run python super_metroid/scripts/probe/bomb_torizo_combat.py eval --state natural --episodes 1
