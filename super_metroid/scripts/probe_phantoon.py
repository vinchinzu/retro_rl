...
uv run python super_metroid/scripts/probe_phantoon.py fight --frames 6000
...
def main() -> None:
    ...
    cap.add_argument("--source", type=Path, default=RED_TOWER_STATE)
    ...
    route.add_argument("--source", type=Path, default=RED_TOWER_STATE)
