...
**Seeded by:** [Early Spazer epic](../tasks/SPAZER_EARLY.md)
...
| 10 | Spazer Beam | `beams` 0x04 | 🔷 in progress | [SPAZER_EARLY](../../docs/tasks/SPAZER_EARLY.md) | Inserted during K2 Below Spazer; walljump path |
...
**Ladder:** [`SPAZER_EARLY.md`](../tasks/SPAZER_EARLY.md) → `SM-SPAZER-*` cards.
...
| Rule | Detail |
|------|--------|
| any% KPDR remains primary | M8 assisted full clear stays the default tip (`--to frog` → … → credits) |
...
| [SPAZER_EARLY.md](../tasks/SPAZER_EARLY.md) | First 100% insert — Spazer walljump detour |
