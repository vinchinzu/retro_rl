...
```bash
uv run python super_metroid/scripts/run_room_problem.py list --tier easy
uv run python super_metroid/scripts/run_room_problem.py scaffold PROBLEM_ID
uv run python super_metroid/scripts/run_room_problem.py ready
...
```bash
uv run python super_metroid/scripts/run_room_problem.py capture \
...
```bash
uv run python super_metroid/scripts/run_room_problem.py teleport \
  room_9879_from_9804_to_92fd \
  --screenshot super_metroid/debug_room_clears/flyway_start.png
```
...
```bash
uv run python super_metroid/scripts/run_room_problem.py run \
  room_9879_from_9804_to_92fd
```
...
```bash
uv run python super_metroid/scripts/run_room_problem.py route \
  0x9B5B 0x9E11 \
