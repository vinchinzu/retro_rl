...
```bash
uv run python super_metroid/scripts/room/run_problem.py capture \
...
```bash
uv run python super_metroid/scripts/room/run_problem.py teleport \
  room_9879_from_9804_to_92fd \
...
```bash
uv run python super_metroid/scripts/room/run_problem.py run \
  room_9879_from_9804_to_92fd
```
...
```bash
uv run python super_metroid/scripts/room/run_problem.py route \
  0x9B5B 0x9E11 \
