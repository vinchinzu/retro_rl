# TASK SM-ROOM-SEG-35: Dual-track room segment — Wrecked Ship Energy Tank Room
...
- optional residual: `docs/tasks/SM-ROOM-SEG-35-residual.md`
- optional note: `docs/tasks/SM-ROOM-SEG-35-note.md`
...
- Queue rank **95**, room `0xCC27` **Wrecked Ship Energy Tank Room**, problem `room_cc27_from_cbd5_to_cbd5`.
...
5. Write residual with PROCESS schema. Next card may be a one-knob residual
   for this same problem (`SM-ROOM-SEG-35-R1`) or `none` if green+promoted.
...
## Done when
Residual filed (message and/or `SM-ROOM-SEG-35-residual.md`). Planner owns queue
