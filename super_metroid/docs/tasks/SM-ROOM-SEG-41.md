# TASK SM-ROOM-SEG-41: Dual-track room segment — Ice Beam Snake Room
...
- optional residual: `docs/tasks/SM-ROOM-SEG-41-residual.md`
- optional note: `docs/tasks/SM-ROOM-SEG-41-note.md`
...
- Queue rank **101**, room `0xA8B9` **Ice Beam Snake Room**, problem `room_a8b9_from_a890_to_a865`.
...
5. Write residual with PROCESS schema. Next card may be a one-knob residual
   for this same problem (`SM-ROOM-SEG-41-R1`) or `none` if green+promoted.
...
## Done when
Residual filed (message and/or `SM-ROOM-SEG-41-residual.md`). Planner owns queue
