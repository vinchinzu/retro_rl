# TASK SM-ROOM-SEG-17: Dual-track room segment — Watering Hole
...
- optional residual: `docs/tasks/SM-ROOM-SEG-17-residual.md`
- optional note: `docs/tasks/SM-ROOM-SEG-17-note.md`
...
- Queue rank **86**, room `0xD13B` **Watering Hole**, problem `room_d13b_from_d16d_to_d16d`.
...
5. Write residual with PROCESS schema. Next card may be a one-knob residual
   for this same problem (`SM-ROOM-SEG-17-R1`) or `none` if green+promoted.
...
## Done when
Residual filed (message and/or `SM-ROOM-SEG-17-residual.md`). Planner owns queue
