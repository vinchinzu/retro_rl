# TASK SM-ROOM-SEG-28: Dual-track room segment — Double Chamber
...
- optional residual: `docs/tasks/SM-ROOM-SEG-28-residual.md`
- optional note: `docs/tasks/SM-ROOM-SEG-28-note.md`
...
- Queue rank **100**, room `0xADAD` **Double Chamber**, problem `room_adad_from_adde_to_ad5e`.
...
5. Write residual with PROCESS schema. Next card may be a one-knob residual
   for this same problem (`SM-ROOM-SEG-28-R1`) or `none` if green+promoted.
...
## Done when
Residual filed (message and/or `SM-ROOM-SEG-28-residual.md`). Planner owns queue
