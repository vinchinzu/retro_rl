# TASK SM-ROOM-SEG-12: Dual-track room segment — X-Ray Room
...
- optional residual: `docs/tasks/SM-ROOM-SEG-12-residual.md`
- optional note: `docs/tasks/SM-ROOM-SEG-12-note.md`
...
- Queue rank **72**, room `0xA2CE` **X-Ray Room**, problem `room_a2ce_from_a293_to_a293`.
...
5. Write residual with PROCESS schema. Next card may be a one-knob residual
   for this same problem (`SM-ROOM-SEG-12-R1`) or `none` if green+promoted.
...
## Done when
Residual filed (message and/or `SM-ROOM-SEG-12-residual.md`). Planner owns queue
