# TASK SM-ROOM-SEG-47: Dual-track room segment — Wrecked Ship East Super Room
...
- optional residual: `docs/tasks/SM-ROOM-SEG-47-residual.md`
- optional note: `docs/tasks/SM-ROOM-SEG-47-note.md`
...
- Queue rank **107**, room `0xCDF1` **Wrecked Ship East Super Room**, problem `room_cdf1_from_caf6_to_caf6`.
...
5. Write residual with PROCESS schema. Next card may be a one-knob residual
   for this same problem (`SM-ROOM-SEG-47-R1`) or `none` if green+promoted.
...
## Done when
Residual filed (message and/or `SM-ROOM-SEG-47-residual.md`). Planner owns queue
