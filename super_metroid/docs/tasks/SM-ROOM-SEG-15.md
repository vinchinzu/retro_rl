# TASK SM-ROOM-SEG-15: Dual-track room segment — East Tunnel
...
- optional residual: `docs/tasks/SM-ROOM-SEG-15-residual.md`
- optional note: `docs/tasks/SM-ROOM-SEG-15-note.md`
...
- Queue rank **84**, room `0xCF80` **East Tunnel**, problem `room_cf80_from_d21c_to_cefb`.
...
5. Write residual with PROCESS schema. Next card may be a one-knob residual
   for this same problem (`SM-ROOM-SEG-15-R1`) or `none` if green+promoted.
...
## Done when
Residual filed (message and/or `SM-ROOM-SEG-15-residual.md`). Planner owns queue
