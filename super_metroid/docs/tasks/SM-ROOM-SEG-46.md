# TASK SM-ROOM-SEG-46: Dual-track room segment — Botwoon Energy Tank Room
...
- optional residual: `docs/tasks/SM-ROOM-SEG-46-residual.md`
- optional note: `docs/tasks/SM-ROOM-SEG-46-note.md`
...
- Queue rank **106**, room `0xD7E4` **Botwoon Energy Tank Room**, problem `room_d7e4_from_d913_to_d95e`.
...
5. Write residual with PROCESS schema. Next card may be a one-knob residual
   for this same problem (`SM-ROOM-SEG-46-R1`) or `none` if green+promoted.
...
## Done when
Residual filed (message and/or `SM-ROOM-SEG-46-residual.md`). Planner owns queue
