# TASK SM-ROOM-SEG-38: Dual-track room segment — Cathedral Entrance
...
- optional residual: `docs/tasks/SM-ROOM-SEG-38-residual.md`
- optional note: `docs/tasks/SM-ROOM-SEG-38-note.md`
...
- Queue rank **98**, room `0xA7B3` **Cathedral Entrance**, problem `room_a7b3_from_a788_to_a7de`.
...
5. Write residual with PROCESS schema. Next card may be a one-knob residual
   for this same problem (`SM-ROOM-SEG-38-R1`) or `none` if green+promoted.
...
## Done when
Residual filed (message and/or `SM-ROOM-SEG-38-residual.md`). Planner owns queue
