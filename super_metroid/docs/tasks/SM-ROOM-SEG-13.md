# TASK SM-ROOM-SEG-13: Dual-track room segment — Alpha Power Bomb Room
...
- optional residual: `docs/tasks/SM-ROOM-SEG-13-residual.md`
- optional note: `docs/tasks/SM-ROOM-SEG-13-note.md`
...
- Queue rank **73**, room `0xA3AE` **Alpha Power Bomb Room**, problem `room_a3ae_from_a322_to_a322`.
...
5. Write residual with PROCESS schema. Next card may be a one-knob residual
   for this same problem (`SM-ROOM-SEG-13-R1`) or `none` if green+promoted.
...
## Done when
Residual filed (message and/or `SM-ROOM-SEG-13-residual.md`). Planner owns queue
