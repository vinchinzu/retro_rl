# TASK SM-ROOM-SEG-11: Dual-track room segment — Waterway
...
- optional residual: `docs/tasks/SM-ROOM-SEG-11-residual.md`
- optional note: `docs/tasks/SM-ROOM-SEG-11-note.md`
...
- Queue rank **80**, room `0xA0D2` **Waterway**, problem `room_a0d2_from_9d19_to_9d19`.
...
5. Write residual with PROCESS schema. Next card may be a one-knob residual
   for this same problem (`SM-ROOM-SEG-11-R1`) or `none` if green+promoted.
...
## Done when
Residual filed (message and/or `SM-ROOM-SEG-11-residual.md`). Planner owns queue
