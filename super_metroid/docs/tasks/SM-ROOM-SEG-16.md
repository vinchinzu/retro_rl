# TASK SM-ROOM-SEG-16: Dual-track room segment — Spiky Platforms Tunnel
...
- optional residual: `docs/tasks/SM-ROOM-SEG-16-residual.md`
- optional note: `docs/tasks/SM-ROOM-SEG-16-note.md`
...
- Queue rank **76**, room `0xAE07` **Spiky Platforms Tunnel**, problem `room_ae07_from_ae32_to_ad5e`.
...
5. Write residual with PROCESS schema. Next card may be a one-knob residual
   for this same problem (`SM-ROOM-SEG-16-R1`) or `none` if green+promoted.
...
## Done when
Residual filed (message and/or `SM-ROOM-SEG-16-residual.md`). Planner owns queue
