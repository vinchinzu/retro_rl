# TASK SM-ROOM-SEG-44: Dual-track room segment — East Cactus Alley Room
...
- optional residual: `docs/tasks/SM-ROOM-SEG-44-residual.md`
- optional note: `docs/tasks/SM-ROOM-SEG-44-note.md`
...
- Queue rank **104**, room `0xDA2B` **East Cactus Alley Room**, problem `room_da2b_from_d913_to_d9fe`.
...
5. Write residual with PROCESS schema. Next card may be a one-knob residual
   for this same problem (`SM-ROOM-SEG-44-R1`) or `none` if green+promoted.
...
## Done when
Residual filed (message and/or `SM-ROOM-SEG-44-residual.md`). Planner owns queue
