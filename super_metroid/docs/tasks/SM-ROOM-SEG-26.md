# TASK SM-ROOM-SEG-26: Dual-track room segment — Grapple Tutorial Room 3
...
- optional residual: `docs/tasks/SM-ROOM-SEG-26-residual.md`
- optional note: `docs/tasks/SM-ROOM-SEG-26-note.md`
...
- Queue rank **98**, room `0xAB64` **Grapple Tutorial Room 3**, problem `room_ab64_from_ab07_to_abd2`.
...
5. Write residual with PROCESS schema. Next card may be a one-knob residual
   for this same problem (`SM-ROOM-SEG-26-R1`) or `none` if green+promoted.
...
## Done when
Residual filed (message and/or `SM-ROOM-SEG-26-residual.md`). Planner owns queue
