...
# Private hop tables re-exported for historical tests
# (``from continuous import _WAREHOUSE_HOPS``). Same objects as hops.py.
_RED_TOWER_HOPS = _kpdr_hops._RED_TOWER_HOPS
_BAT_HOPS = _kpdr_hops._BAT_HOPS
_BELOW_SPAZER_HOPS = _kpdr_hops._BELOW_SPAZER_HOPS
_WAREHOUSE_HOPS = _kpdr_hops._WAREHOUSE_HOPS
_HIJUMP_HOPS = _kpdr_hops._HIJUMP_HOPS
_KRAID_HOPS = _kpdr_hops._KRAID_HOPS
_VARIA_HOPS = _kpdr_hops._VARIA_HOPS
...
# ===========================================================================
# Post-Supers KPDR tips: hop runner (tables live in routes/kpdr/hops.py)
# ===========================================================================
...
#   4. Append RouteHop(s) / PostSupersTipSpec in routes/kpdr/hops.py; run_*
#      stays a thin run_post_supers_tip(...) wrapper here.
#   5. Wire tip_id → run_* in run_to() + register_continuous_segments.
#
# Hop / tip-spec data is re-exported from :mod:`super_metroid.routes.kpdr.hops`
# (same objects) so historical ``from continuous import _*_HOPS`` still works.
...
# ===========================================================================
# Data-driven post-Supers tip runners (tables: routes/kpdr/hops.py)
# ===========================================================================
# Extend a tip: pure controller → graph → catalog ContinuousTip → add a
# PostSupersTipSpec row in hops.py (parent + hops + report fields). Do not
# clone another play_start_to_* / run_start_to_* pair.
