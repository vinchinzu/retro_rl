"""Run the alttp_rando multi-seed opening tip (house→uncle) S/T campaign."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        choices=("dry", "live"),
        default="dry",
        help="dry = audited fixture harness dry-run; live = real ALTTPRando-Snes tip",
    )
    parser.add_argument(
        "--seeds",
        nargs="+",
    ...
    parser.add_argument(
        "--publish-docs",
        action="store_true",
        help="Also write committed dry report under snes/alttp_rando/docs/",
    )
    parser.add_argument(
        "--seeds-root",
        type=Path,
        default=None,
        help="Directory for fixture seed packages (default: snes/alttp_rando/seeds)",
    )
