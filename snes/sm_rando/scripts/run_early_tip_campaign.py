"""Run the sm_rando multi-seed early tip (ship→morph) S/T campaign."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        choices=("dry", "live"),
        default="dry",
        help="dry = audited fixture harness dry-run; live = real SMRando-Snes morph tip",
    )
    parser.add_argument(
        "--seeds",
        nargs="+",
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Directory for fixture seed packages (default: snes/sm_rando/seeds)",
    )
