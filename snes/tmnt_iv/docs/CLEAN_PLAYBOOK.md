...
This playbook is the source of **play anti-patterns**. Workstream rules
live in [ASSIST_CONTRACT.md](ASSIST_CONTRACT.md) (Clean = both assists
off; `*_clean` stems only). Ready work: `bd ready -l tmnt_iv`.
