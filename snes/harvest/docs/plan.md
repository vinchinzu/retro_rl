...
| Empty-can natural refill | **Partial (rr-3q27)** — F9 sealed from west pocket (unit: no false multihop); corridor_only fence-open + gap densify wired; ROM dry still `can_peak=0` (gap south transit soft-block on (13,31) after clear). Parent rr-20w. |
