...
SCALAR_FIELDS: tuple[RamFieldSpec, ...] = (
    ...
    RamFieldSpec(
        ...
        0,
        255,
        "Current stamina; spa restores to max (often 100–150).",
        data_key="stamina",
    ),
    ...
    RamFieldSpec(
        ...
        0,
        255,
        "Decomp !exaustion_level; tiredness overlay on current stamina.",
    ),
    RamFieldSpec(
        "tool_hit_counter",
        "Hammer/Axe Multi-Hit Counter",
        0x096D,
        "u8",
        "Runtime",
        "decomp",
        0,
        255,
        "Increments toward 6; large rock/stump breaks then STZ. Shared $096D.",
        aliases=("rock_hit_counter",),
    ),
    ...
    RamFieldSpec(
        ...
        0,
        0xFF,
        "Live: 0 idle/walk/run/push (no distinct push code), 3 jump/water, 4 carry, 9 dialogue",
    ),
