...
- `scan_ram.py`, `scan_ram_v2.py`, `locate_map.py` - RAM scanning utilities
- `find_pond.py`, `map_dump_pond.py` - Pond location finding
- `debug_carry.py`, `debug_carry_v2.py` - Debug item carrying mechanics
- `get_player_pos.py`, `dump_ram_more.py` - Position and RAM debugging
