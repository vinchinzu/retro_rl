...
**Implementation:** `retro_harness/fighters/ram_observation.py`
...
Unknown addresses in local agent notes (difficulty, position) are the blocker for
...
| Combo macros | `ComboFrameSkip` in `retro_harness/fighters/combo_wrapper.py` | E016 |
