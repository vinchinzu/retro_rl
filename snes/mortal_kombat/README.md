...
- [AGENTS.md](AGENTS.md) — commands and traps
- [SPEEDRUN_PLAN.md](SPEEDRUN_PLAN.md) — tournament structure and training design
- [docs/experiments.md](docs/experiments.md) — experiment backlog
- [docs/ram_policy_plan.md](docs/ram_policy_plan.md) — RAM policy work
