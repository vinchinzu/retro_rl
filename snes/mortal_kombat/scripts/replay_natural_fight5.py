#!/usr/bin/env python3
"""Replay the model-free power-on Liu Kang Match 1–5 input tape."""
...
from mortal_kombat.natural_fight5_tape import (  # noqa: E402
...
NATURAL_THROUGH_FIGHT5_FRAMES = NATURAL_THROUGH_FIGHT4_FRAMES + NATURAL_FIGHT5_FRAMES
NATURAL_THROUGH_FIGHT5_RLE = NATURAL_THROUGH_FIGHT4_RLE + NATURAL_FIGHT5_RLE
MATCHES = (0, 1, 2, 3, 4)
...
def main() -> int:
    ...
    for attempt in range(args.repeat):
        ...
        try:
            ...
            env.close()
        transitioned = snap.match_counter >= 5 and snap.p1_character == LIU_KANG_ID
        ...
        print(
            ...
            f"identical={identical} frame={frame}/{NATURAL_THROUGH_FIGHT5_FRAMES} "
