#!/usr/bin/env python3
"""Replay the model-free power-on Liu Kang Match 1+2+3 input tape."""
...
from mortal_kombat.natural_fight3_tape import (  # noqa: E402
...
NATURAL_THROUGH_FIGHT3_FRAMES = NATURAL_THROUGH_FIGHT2_FRAMES + NATURAL_FIGHT3_FRAMES
NATURAL_THROUGH_FIGHT3_RLE = NATURAL_THROUGH_FIGHT2_RLE + NATURAL_FIGHT3_RLE
MATCHES = (0, 1, 2)
...
def main() -> int:
    ...
    for attempt in range(args.repeat):
        ...
        try:
            ...
            env.close()
        transitioned = snap.match_counter >= 3 and snap.p1_character == LIU_KANG_ID
        ...
        print(
            ...
            f"identical={identical} frame={frame}/{NATURAL_THROUGH_FIGHT3_FRAMES} "
