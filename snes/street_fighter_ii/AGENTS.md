...
# Train
uv run python retro_harness/fighters/train_ppo.py --game sf2 --state Fight_StreetFighterIITurbo --steps 500000

# Evaluate
uv run python retro_harness/fighters/train_ppo.py --game sf2 --state Fight_StreetFighterIITurbo --eval --load models/sf2_ppo_final.zip
