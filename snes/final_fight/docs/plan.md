...
Implemented in `final_fight/policy.py` using `retro_harness.combat.build_segment_tree`
...
Reusable combat / chain helpers: `retro_harness/combat.py`,
`retro_harness/segment_runner.WaveChainTracker`.
