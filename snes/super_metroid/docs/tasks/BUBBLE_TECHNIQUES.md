...
Related: hard-room playbook [`HARD_ROOM_SPLITS.md`](HARD_ROOM_SPLITS.md).
Tip closed: Bubble → Bat continuous green (122304f). This file is a maintenance
technique ref for bubble controller code — not a living card stack.
