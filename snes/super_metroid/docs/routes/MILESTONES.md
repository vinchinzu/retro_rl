...
| ✅ | `M-FROG` | K4 | Continuous → Frog Savestation (**side tip**) | `0xB167` | 114923 | `frog` (not primary) |
...
| ✅ | `C-BOMBS` | Continuous → Bombs/Torizo (**Clean**) ★ | `0x92FD` | **49,321f** ×2 | hybrid clean BT + exit tail |
| ⏸ | `C-SPORE` | Continuous → Spore (**Clean**) | `0x9DC7` | — | parked until C-BOMBS stab/status |
...
| ✅ | `A-TIPSPEC` | Data-driven continuous tips complete | — | hops.py + PostSupersTipSpec + alias bind |
