...
uv run python snes/super_metroid/scripts/probe/bomb_torizo_combat.py --state BossTorizo
# or explicit:
...
uv run python snes/super_metroid/scripts/probe/bomb_torizo_combat.py eval --state natural
...
```bash
uv run python snes/super_metroid/scripts/probe/bomb_torizo_combat.py train \
