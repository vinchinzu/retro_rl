...
★ Next: WS Main Shaft → basement (`0xCAF6` → `0xCC6F`, `rr-4btp`) from the
Entrance→Main leave (scratch dual **403f** ×2 `0xCAF6` `(1063,907)` p9 gs=8,
not STATUS). Residual: [`tasks/rr-ahjo-residual.md`](tasks/rr-ahjo-residual.md).
