...
| `post_ice_red_to_hellway_pure` | `scratch/post_ice_red_to_hellway_pure.state` | `0xA2F7` Hellway left ~(42,153) p29 | dual GREEN Red→Hellway (rr-av5s, **6199f** ×2); warehouse_to_red hop 6 body; items `0x3105` beams `0x1007` | Hellway→Caterpillar (K5 hop 13) |
