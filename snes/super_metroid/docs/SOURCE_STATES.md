...
| `post_business_to_ice_gate_pure` | `scratch/post_business_to_ice_gate_pure.state` | `0xA815` Ice Gate ~(1752,651) p2 | pure dual GREEN Business→Ice Gate (rr-fg3, 894f ×2) | pure Ice Gate→Acid predecessor |
