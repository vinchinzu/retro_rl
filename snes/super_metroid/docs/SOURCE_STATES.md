...
| `post_phantoon_leave` | `scratch/post_phantoon_leave.state` | `0xCC6F` WS Basement ~(1240,139) p10 | doppler + loot/exit dual **12455f** ×2 (rr-asyg; fight 12118 + leave 337); `$D82B` bit 0, gs=8; **not** STATUS | WS power-on / Gravity |
