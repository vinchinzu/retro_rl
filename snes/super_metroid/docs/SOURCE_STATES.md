...
| `post_ice_snake_to_ice_pure` | `scratch/post_ice_snake_to_ice_pure.state` | `0xA890` Ice ~(187,120) beams `0x1007` | pure dual GREEN Snake→Ice PLM (rr-5if, **1756f** ×2) | Ice return / stack compose |
...
| `post_speedway_to_frog_save_pure` | `scratch/post_speedway_to_frog_save_pure.state` | `0xB167` Frog Save **right** ~(216,122) p82 | pure dual GREEN Speedway→Frog (rr-05dp, **621f** ×2); items `0x3105` | pure Frog→Business return (rr-vsjy; replace scaffold) |
