...
| `post_ice_bat_to_red_pure` | `scratch/post_ice_bat_to_red_pure.state` | `0xA253` Red Tower bottom ~(216,2443) p10 | pure dual GREEN Bat→Red (rr-0ue1, **718f** ×2); items `0x3105` beams `0x1007` | pure Red→Hellway climb (K5 hop 12) |
