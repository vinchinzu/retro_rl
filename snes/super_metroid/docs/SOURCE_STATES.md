...
| `post_phantoon_poweron` | `scratch/post_phantoon_poweron.state` | `0xCD13` Phantoon's Room ~(37,187) p1 | assist dual-green fight **20537f** ×2 (rr-tlaq); HP 0, `$D82B` bit 0, gs=8, health 299; **not** STATUS; do not clobber `post_phantoon_defeated` | WS power-on / leave |
