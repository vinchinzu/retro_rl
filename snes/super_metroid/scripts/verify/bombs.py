"""Independently verify a bombs tip report and video artifact."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--report",
        type=Path,
        default=RECORDINGS_DIR / "bombs.json",
    )
    parser.add_argument(
        "--video",
        type=Path,
        default=RECORDINGS_DIR / "bombs.mp4",
    )
    parser.add_argument(
        "--output",
        type=Path,
        default=RECORDINGS_DIR / "bombs.verify.json",
    )
