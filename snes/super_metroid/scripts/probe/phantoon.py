...
```bash
uv run python snes/super_metroid/scripts/probe/phantoon.py collect-pb
# Skip pure Pink PB / GHZ / Noob (dev bridge) and land Red Tower with PB:
uv run python snes/super_metroid/scripts/probe/phantoon.py skip-to-red
uv run python snes/super_metroid/scripts/probe/phantoon.py skip-to-ghz
uv run python snes/super_metroid/scripts/probe/phantoon.py capture-entry
uv run python snes/super_metroid/scripts/probe/phantoon.py fight --frames 6000
uv run python snes/super_metroid/scripts/probe/phantoon.py ship-route
```
"""
