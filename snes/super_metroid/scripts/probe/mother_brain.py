...
```bash
uv run python snes/super_metroid/scripts/probe/mother_brain.py capture-mb
uv run python snes/super_metroid/scripts/probe/mother_brain.py capture-escape1
uv run python snes/super_metroid/scripts/probe/mother_brain.py spray-mb --frames 3600
uv run python snes/super_metroid/scripts/probe/mother_brain.py run-escape --frames 12000
```
"""
