...
from super_metroid.routes.kpdr.red_tower.red_to_hellway_common import (
    _DATA,
    _in_hellway,
    _in_red,
    _unmorph,
)
from super_metroid.routes.kpdr.red_tower.red_to_hellway_mid import _climb_mid
from super_metroid.routes.kpdr.red_tower.red_to_hellway_upper import _climb_upper
...
def play_red_to_hellway(session: ControllerSession) -> SuperMetroidState:
    ...
    from super_metroid.routes.kpdr.red_tower.red_ice_climb import can_attach_bottom_edge
    from super_metroid.routes.kpdr.red_tower.red_ice_to_hellway import play_ice_climb_to_hellway
