...
from super_metroid.routes.kpdr.red_tower.bat_to_red import play_bat_to_red
from super_metroid.routes.kpdr.red_tower.below_to_bat import play_below_to_bat
from super_metroid.routes.kpdr.red_tower.caterpillar_to_alpha_pb import (
    play_caterpillar_to_alpha_pb,
)
from super_metroid.routes.kpdr.red_tower.east_to_glass import play_east_to_glass
from super_metroid.routes.kpdr.red_tower.glass_to_west import play_glass_to_west
from super_metroid.routes.kpdr.red_tower.hellway_to_caterpillar import (
    play_hellway_to_caterpillar,
)
from super_metroid.routes.kpdr.red_tower.red_to_hellway import play_red_to_hellway
from super_metroid.routes.kpdr.red_tower.warehouse_to_east import play_warehouse_to_east
from super_metroid.routes.kpdr.red_tower.west_to_below import play_west_to_below
