...
POST_SUPERS_SPINE: tuple[SpineHop, ...] = (
    ...
    # (rr-kxge); living tip is phantoon (rr-b926).
    SpineHop(
        "wave_to_double_chamber",
        play_wave_to_double_chamber,
        ROOM_WAVE,
        ROOM_DOUBLE_CHAMBER,
        "Double Chamber (Wave return)",
        "ice",
        exit_direction="left",
        entry_direction="right",
        requires=_K4_CAPS | frozenset({"missiles"}),
    ...
    SpineHop(
        ...
        ROOM_BUBBLE,
        ROOM_UPPER_NORFAIR_FARM,
        "Upper Norfair Farm (Wave return)",
        "ice",
        exit_direction="left",
        entry_direction="right",
    ...
    SpineHop(
        ...
        ROOM_FROG_SAVE,
        ROOM_BUSINESS,
        "Business Center (Wave return floor)",
        "ice",
        exit_direction="left",
        entry_direction="right",
        requires=_K4_CAPS,
