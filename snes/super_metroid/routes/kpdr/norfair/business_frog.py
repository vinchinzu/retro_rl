"""Norfair Business ↔ Frog Save, Frog Speedway, and post-Speed farm shortcuts.

Business Center → Frog Save is the accepted continuous extension (save
