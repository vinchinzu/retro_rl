"""Post-Phantoon Attic→Gravity s23 tapes + Gravity Suit collect.

Transit hops replay settled s23 bodies and stop on dest-room gs=8.
...
def play_attic_to_west_ocean(session: ControllerSession) -> SuperMetroidState:
    return _play_s23_to_room(
        ...
        start_room=ROOM_WS_ATTIC,
        dest_room=ROOM_WEST_OCEAN,
        body=load_s23_body(ATTIC_HOP_BODY),
    )
