"""Ceres falling-tile → magnet tape (slice of product outbound prefix)."""
...
CeresSecondRoomFixture = CeresRoomTape


def get_ceres_second_room_tape() -> CeresRoomTape:
    return get_ceres_room_tape("second")
...
def validate_ceres_second_room(
    ...
    return validate_ceres_room_tape(fixture, "second", start_state_path)
