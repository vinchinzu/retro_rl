...
POST_ICE_SPINE: tuple[SpineHop, ...] = (
    ...
    # --- gravity (scratch --to gravity; Main Shaft residual still RED) ---
    SpineHop(
        "ws_basement_to_main",
        play_ws_basement_to_main,
        ROOM_WS_BASEMENT,
        ROOM_WS_MAIN,
        "Wrecked Ship Main Shaft (powered)",
        "gravity",
        exit_direction="up",
        entry_direction="down",
        requires=_K4_SPEED_CAPS,
        policy_id="kpdr_k6_gravity",
        leave=LEAVE_BY_HOP["ws_basement_to_main"],
    ),
    SpineHop(
        "ws_main_to_attic",
        play_ws_main_to_attic,
        ...
        requires=_K4_SPEED_CAPS,
        policy_id="kpdr_k6_gravity",
        leave=LEAVE_BY_HOP["ws_main_to_attic"],
    ),
    SpineHop(
        "attic_to_west_ocean",
        play_attic_to_west_ocean,
        ROOM_WS_ATTIC,
        ROOM_WEST_OCEAN,
        "West Ocean (Attic gray door)",
        "gravity",
        requires=_K4_SPEED_CAPS,
        policy_id="kpdr_k6_gravity",
        leave=LEAVE_BY_HOP["attic_to_west_ocean"],
    ),
    SpineHop(
        ...
        requires=_K4_SPEED_CAPS,
        policy_id="kpdr_k6_gravity",
        leave=LEAVE_BY_HOP["west_ocean_to_pancakes"],
    ),
    SpineHop(
        ...
        requires=_K4_SPEED_CAPS,
        policy_id="kpdr_k6_gravity",
        leave=LEAVE_BY_HOP["pancakes_to_homing_geemer"],
    ),
    SpineHop(
        ...
        requires=_K4_SPEED_CAPS,
        policy_id="kpdr_k6_gravity",
        leave=LEAVE_BY_HOP["homing_geemer_to_bowling"],
    ),
    SpineHop(
        "bowling_to_gravity",
        play_bowling_to_gravity,
        ...
        requires=_K4_SPEED_CAPS,
        policy_id="kpdr_k6_gravity",
        leave=LEAVE_BY_HOP["bowling_to_gravity"],
    ),
    SpineHop(
        "gravity_collect",
        play_gravity_collect,
        ROOM_GRAVITY,
        ROOM_GRAVITY,
        "Gravity Suit collected",
        "gravity",
        use_transition_split=False,
        after=require_gravity_collected,
        requires=_K4_SPEED_CAPS,
        policy_id="kpdr_k6_gravity",
        leave=LEAVE_BY_HOP["gravity_collect"],
    ),
)
