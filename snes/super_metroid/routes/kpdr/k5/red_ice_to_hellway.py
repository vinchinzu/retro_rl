...
from super_metroid.routes.kpdr.k5.red_ice_mid_to_thin import play_mid_floor_to_thin_seat
from super_metroid.routes.kpdr.k5.red_ice_r1_to_r2 import play_ripper1_to_ripper2
from super_metroid.routes.kpdr.k5.red_ice_r2_to_r3 import play_ripper2_to_ripper3
from super_metroid.routes.kpdr.k5.red_ice_r3_to_r4 import play_ripper3_to_ripper4
from super_metroid.routes.kpdr.k5.red_ice_r4_to_tunnel import play_ripper4_to_tunnel
from super_metroid.routes.kpdr.k5.red_ice_thin_to_ur1 import (
    play_thin_seat_to_upper_ripper1,
)
from super_metroid.routes.kpdr.k5.red_ice_tunnel_to_mid import play_tunnel_to_mid_floor
