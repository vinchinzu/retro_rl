...
SOURCE_CATALOG: tuple[SourceFingerprint, ...] = (
    ...
    SourceFingerprint(
        "post_ice_ceres_successor",
        "scratch/post_ice_ceres_successor.state",
        0xA890,
        use_for="Ceres-successor --to ice dual 146937f leave; ice-to-snake continuous predecessor",
        x_min=160,
        x_max=220,
        y_min=100,
        y_max=160,
    ...
    SourceFingerprint(
        "post_bubble_entry_continuous",
        "scratch/post_bubble_entry_continuous.state",
        0xACB3,
        use_for="natural Bubble entry on Ceres-successor spine; bubble-to-bat-cave",
        x_min=20,
        x_max=80,
        y_min=620,
        y_max=660,
        poses=frozenset({1, 2, 9, 25, 81}),
    ),
    SourceFingerprint(
        "post_bat_cave_continuous_ceres_successor",
        "scratch/post_bat_cave_continuous_ceres_successor.state",
        0xB07A,
        use_for="Ceres-successor --to bat_cave leave (rr-v5c1); bat-cave-to-speed-hall / Ice compose",
        x_min=20,
        x_max=60,
        y_min=360,
        y_max=410,
        poses=frozenset({1, 81}),
    ),
    SourceFingerprint(
    ...
    SourceFingerprint(
        "post_ice_red_to_hellway_pure",
        "scratch/post_ice_red_to_hellway_pure.state",
        0xA2F7,
        use_for="K5 hop 12 tape leave (rr-av5s 6199f p29); Ice-pin spine is ordinary (39,139) p11",
        continuous_like=False,
        x_min=20,
        x_max=80,
        y_min=120,
        ...
        poses=frozenset({1, 2, 9, 10, 11, 12, 25, 26, 29, 30, 81, 82}),
    ),
    SourceFingerprint(
        "post_ice_hellway_to_caterpillar_pure",
        "scratch/post_ice_hellway_to_caterpillar_pure.state",
        0xA322,
        use_for="K5 hop 13 handoff (rr-bvd1 Hellway-to-Caterpillar dual 2218f); Caterpillar→Alpha PB",
        continuous_like=False,
        x_min=20,
        x_max=80,
        y_min=1380,
        y_max=1450,
        poses=frozenset({1, 2, 9, 10, 11, 12, 25, 26, 81, 82}),
    ),
    SourceFingerprint(
        "post_ice_caterpillar_to_alpha_pb_pure",
        "scratch/post_ice_caterpillar_to_alpha_pb_pure.state",
        0xA3AE,
        use_for="K5 hop 14 handoff (rr-dbu.8 dual 1385f); Ice-pin compose Alpha PB 20016f; Moat approach",
        continuous_like=False,
        x_min=320,
        x_max=365,
        y_min=150,
    ...
    SourceFingerprint(
        "post_alpha_pb_to_caterpillar_pure",
        "scratch/post_alpha_pb_to_caterpillar_pure.state",
        0xA322,
        use_for="K6 hop 0 handoff (Alpha PB escape dual 2102f); Caterpillar climb",
        continuous_like=False,
        x_min=20,
        x_max=80,
        y_min=1910,
        y_max=1940,
        poses=frozenset({1, 2, 9, 10, 164}),
    ),
    SourceFingerprint(
        "post_caterpillar_to_elevator_pure",
        "scratch/post_caterpillar_to_elevator_pure.state",
        0x962A,
        use_for="K6 hop 1 handoff (Caterpillar climb dual 1869f); elevator to Kihunter",
        continuous_like=False,
        x_min=110,
        x_max=145,
        y_min=270,
    ...
    SourceFingerprint(
        "post_elevator_to_kihunter_pure",
        "scratch/post_elevator_to_kihunter_pure.state",
        0x948C,
        use_for="K6 hop 2 handoff (elevator to Kihunter dual 627f); Kihunter to Moat",
        continuous_like=False,
        x_min=370,
        x_max=415,
        y_min=670,
    ...
    SourceFingerprint(
        "post_kihunter_to_moat_pure",
        "scratch/post_kihunter_to_moat_pure.state",
        0x95FF,
        use_for="K6 hop 3 handoff (Kihunter to Moat dual 1844f); Moat spark",
        continuous_like=False,
        x_min=20,
        x_max=80,
        y_min=120,
    ...
    SourceFingerprint(
        "post_moat_poweron",
        "scratch/post_moat_poweron.state",
        0x93FE,
        use_for="power-on --to moat dual 175526f leave (rr-2r06); west-ocean spark to WS",
        x_min=30,
        x_max=80,
        y_min=1140,
        y_max=1185,
    ...
    SourceFingerprint(
        "post_moat_poweron_wo_to_ws",
        "scratch/post_moat_poweron_wo_to_ws.state",
        0xCA08,
        use_for="over-ocean spark from power-on moat leave dual 627f; WS entrance",
        x_min=40,
        x_max=90,
        y_min=120,
        y_max=160,
    ...
    SourceFingerprint(
        ...
        0xCAF6,
        use_for="pure dual GREEN Entrance→Main (rr-ahjo, 403f ×2); Main Shaft → basement (rr-4btp)",
        x_min=1020,
        x_max=1100,
        y_min=870,
        y_max=940,
    ...
    SourceFingerprint(
        "post_ws_main_to_basement",
        "scratch/post_ws_main_to_basement.state",
        0xCC6F,
        use_for="pure dual GREEN Main Shaft→basement (rr-4btp, 1208f ×2); Basement → Phantoon",
        x_min=600,
        x_max=720,
        y_min=60,
        y_max=160,
