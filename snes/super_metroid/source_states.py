...
SOURCE_CATALOG: tuple[SourceFingerprint, ...] = (
    ...
    SourceFingerprint(
        ...
        0xA2F7,
        use_for="K5 hop 12 handoff (rr-av5s red-to-hellway dual 6199f); Hellway→Caterpillar",
        continuous_like=False,
        x_min=20,
        x_max=80,
        y_min=120,
        y_max=180,
        # 29 = morph after door settle; standing/run accepted for next hop.
        poses=frozenset({1, 2, 9, 10, 12, 25, 26, 29, 30, 81, 82}),
    ),
    SourceFingerprint(
