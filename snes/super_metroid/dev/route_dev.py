...
DEFAULT_CONTINUOUS_PREFIX_VIDEO = RECORDINGS_DIR / "supers.mp4"
...
def run_hybrid_full_route(
    *,
    ...
    1. Uses existing continuous ``supers`` (or another prefix clip).
    ...
    if prefix_path is not None and not prefix_path.is_file():
        raise FileNotFoundError(
            ...
            "Record it with: uv run python snes/super_metroid/scripts/record/continuous.py --to supers"
        )
