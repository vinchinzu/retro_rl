...
from super_metroid.routes.kpdr import k4_norfair, to_bat_cave
...
def test_bubble_to_single_chamber_is_registered_for_pure_segment_use() -> None:
    from super_metroid.routes.kpdr import get_segment

    assert (
        get_segment("bubble_to_single_chamber")
        is k4_norfair.play_bubble_to_single_chamber
    )
    assert k4_norfair.ROOM_SINGLE_CHAMBER == 0xAD5E


def test_single_to_double_chamber_is_registered_for_pure_segment_use() -> None:
    from super_metroid.routes.kpdr import get_segment

    assert (
        get_segment("single_to_double_chamber")
        is k4_norfair.play_single_to_double_chamber
    )
...
def test_bubble_phase_helpers_are_importable() -> None:
    helpers = (
        to_bat_cave.bubble_land_and_prepare,
        to_bat_cave.bubble_lower_to_mid_pin,
        to_bat_cave.bubble_mid_repin,
        to_bat_cave.bubble_run_mid,
        to_bat_cave.bubble_top_super_door,
        to_bat_cave.bubble_phase_d_near_top,
        to_bat_cave.bubble_is_true_ground,
        to_bat_cave.bubble_on_mid_iso_pin,
        to_bat_cave.bubble_on_launch_lip,
        to_bat_cave.bubble_on_right_shelf,
        to_bat_cave.bubble_on_save_runway,
    )
