...
from super_metroid.routes.kpdr.k5.caterpillar_to_alpha_pb import _entry_shelf_dir
...
from super_metroid.routes.kpdr.k5.hellway_to_caterpillar import _in_right_door_band
