...
uv run python retro_harness/fighters/train_ppo.py --game ssf2 --state Fight_SuperStreetFighterII --steps 500000
uv run python retro_harness/fighters/train_ppo.py --game ssf2 --state Fight_SuperStreetFighterII --eval --load models/ssf2_ppo_final.zip
```
